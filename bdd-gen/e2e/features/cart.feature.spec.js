...
test.describe('Add Products in Cart', () => {
  ...
  test('Add two different products to cart', { tag: ['@Automated'] }, async ({ Given, When, Then, And, accountStatusPagePo, cartPagePo, checkoutPagePo, headerPagePo, homepagePo, loginPagePo, paymentPagePo, productsPagePo, signupPagePo }) => { 
    ...
    await When('I enter description in comment text area and click \'Place Order\'', null, { checkoutPagePo }); 
    await Then('I enter payment details', null, { paymentPagePo }); 
    await When('I click \'Download Invoice\' button', null, { paymentPagePo }); 
    await Then('invoice is downloaded successfully', null, { paymentPagePo }); 
    await Then('I click \'Delete Account\' button', null, { accountStatusPagePo, headerPagePo }); 
  });
